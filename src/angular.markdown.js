...
angular.module('angular.markdown', ['ngSanitize'])
    ...
    .factory('mdParser', ['$sanitize', '$window', function($sanitize, $window){
    ...
    .directive('markdown', ['mdParser', function(mdParser){
    ...
    .directive('mdEditor', ['mdParser', '$window', function(mdParser, $window){
        return {
            restrict: 'EA',
            replace: true,
